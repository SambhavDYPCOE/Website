...
export const eventsData = [
  ...
  },
  {
    ...
    rules: ["Get ready to embark on a thrilling digital adventure! This online treasure hunt will take you on a journey through the web as you decode clues, complete challenges and discover hidden treasures, work your way through the puzzle and be crowned the ultimate champion!", 
    "Disclaimer :", 
    ...
    prizes: ["Each individual who successfully finds treasure in his first attempt will be rewarded with special GOODIES."],
    team: "Individual",
  ...
  },
  {
    ...
    prizes: ["Each team that successfully completes all the questions in their first attempt will be rewarded with special GOODIES"],
    team: "2 members",
    fees: "25Rs. per team",
    contactInfo: [
  ...
  },
  {
    ...
    prizes: ["Each individual who successfully completes all rounds of code questions will win goodies"],
    team: "Individual",
    fees: "20Rs. per person",
    contactInfo: [
  ...
  },
  {
    ...
    image: test,
    name: "ROBO Race",
    description: " Teams have to build a manually controlled bot with the aim to tackle maximum number of obstacles in minimum amount of time.",
    rules: [
      "BOT SPECIFICATIONS:",
   ...
   },
  {
    ...
    image: test,
    name: "ROBO Soccer",
    description: "Two bots face off in an exhilarating match of football. Teams have to build a bot capable scoring goals and also defend against the opponent.",
    rules: [
      "BOT SPECIFICATIONS:",
