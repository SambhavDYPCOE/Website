      ...
      <div className={classes.about}>
        <div className={classes.details}>
          ...
          <p className={classes.para}>
            Its the annual national-level technomanagerial cultural extravaganza
            of the KMCT College of Engineering. Karma invites innovative minds
            to compete with each other, share ideas and educate people about new
            technological advancements and be a part of the tech platform.
          </p>
